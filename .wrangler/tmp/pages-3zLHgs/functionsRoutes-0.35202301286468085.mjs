...
import { onRequestGet as __api_test_simple_ts_onRequestGet } from "/home/lium/chatsvtr/functions/api/test-simple.ts"
import { onRequestPost as __api_test_simple_ts_onRequestPost } from "/home/lium/chatsvtr/functions/api/test-simple.ts"
...
export const routes = [
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_test_simple_ts_onRequestGet],
    },
  {
      routePath: "/api/test-simple",
      mountPath: "/api",
      method: "POST",
      middlewares: [],
      modules: [__api_test_simple_ts_onRequestPost],
    },
  {
