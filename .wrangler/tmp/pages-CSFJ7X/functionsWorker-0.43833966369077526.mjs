...
// ../.wrangler/tmp/bundle-f1pc2f/checked-fetch.js
...
var HybridRAGService = class {
  ...
  async loadWeeklyData() {
    return [
      ...
      {
        id: "weekly-114",
        content: `AI\u5468\u62A5\u7B2C114\u671F\uFF1A\u751F\u6210\u5F0FAI\u5E02\u573A\u8D8B\u4E8E\u6210\u719F\uFF0C\u6295\u8D44\u8005\u66F4\u5173\u6CE8\u5546\u4E1A\u6A21\u5F0F\u548C\u76C8\u5229\u80FD\u529B\u3002
        \u5173\u952E\u89C2\u5BDF\uFF1A1\uFF09\u6A21\u578B\u516C\u53F8\u4F30\u503C\u56DE\u5F52\u7406\u6027\uFF1B2\uFF09\u5E94\u7528\u5C42\u521B\u65B0\u52A0\u901F\uFF1B3\uFF09\u6570\u636E\u62A4\u57CE\u6CB3\u4EF7\u503C\u51F8\u663E\u3002
        \u6295\u8D44\u4EAE\u70B9\uFF1A\u591A\u6A21\u6001AI\u5E94\u7528\u83B7\u5F97\u91CD\u70B9\u5173\u6CE8\uFF0C\u8FB9\u7F18AI\u90E8\u7F72\u9700\u6C42\u589E\u957F\uFF0CAI\u57FA\u7840\u8BBE\u65BD\u6301\u7EED\u5347\u6E29\u3002`,
        title: "AI\u5468\u62A5\u7B2C114\u671F",
        type: "weekly",
        source: "\u98DE\u4E66\u77E5\u8BC6\u5E93",
        keywords: ["\u751F\u6210\u5F0FAI", "\u5546\u4E1A\u6A21\u5F0F", "\u591A\u6A21\u6001AI", "\u8FB9\u7F18AI", "\u6570\u636E\u62A4\u57CE\u6CB3"]
      }
    ];
  }
  /**
    ...
    return [
      {
        ...
        \u5E02\u573A\u5730\u4F4D\uFF1A\u4E0EOpenAI\u5F62\u6210\u53CC\u96C4\u5BF9\u5CD9\uFF0C\u5728\u4F01\u4E1A\u7EA7AI\u670D\u52A1\u5E02\u573A\u5360\u636E\u91CD\u8981\u4F4D\u7F6E\u3002`,
        title: "Anthropic\u516C\u53F8\u5206\u6790",
        type: "company",
        source: "AI\u521B\u6295\u5E93",
        keywords: ["Anthropic", "AI\u5B89\u5168", "Claude", "Constitutional AI", "60\u4EBF\u7F8E\u5143", "D\u8F6E\u878D\u8D44"]
      },
      {
        id: "company-scale-ai",
        content: `Scale AI\uFF1AAI\u6570\u636E\u57FA\u7840\u8BBE\u65BD\u7684\u72EC\u89D2\u517D\u4F01\u4E1A\uFF0C\u4E3A\u81EA\u52A8\u9A7E\u9A76\u3001\u673A\u5668\u4EBA\u3001\u56FD\u9632\u7B49\u9886\u57DF\u63D0\u4F9B\u9AD8\u8D28\u91CF\u8BAD\u7EC3\u6570\u636E\u3002
        \u878D\u8D44\u60C5\u51B5\uFF1A2021\u5E74E\u8F6E\u878D\u8D4410\u4EBF\u7F8E\u5143\uFF0C\u4F30\u503C73\u4EBF\u7F8E\u5143\uFF0C\u6B63\u51C6\u5907IPO\u3002
        \u5546\u4E1A\u6A21\u5F0F\uFF1A\u6570\u636E\u6807\u6CE8\u3001\u6A21\u578B\u8BC4\u4F30\u3001AI\u90E8\u7F72\u5E73\u53F0\uFF0C\u670D\u52A1\u6DB5\u76D6\u6574\u4E2AAI\u5F00\u53D1\u5468\u671F\u3002
        \u5BA2\u6237\u57FA\u7840\uFF1A\u7279\u65AF\u62C9\u3001\u4E30\u7530\u3001\u7F8E\u56FD\u56FD\u9632\u90E8\u7B49\u9AD8\u7AEF\u5BA2\u6237\uFF0C\u6536\u5165\u589E\u957F\u5F3A\u52B2\u3002`,
        title: "Scale AI\u516C\u53F8\u5206\u6790",
        type: "company",
        source: "AI\u521B\u6295\u5E93",
...
function generateEnhancedPrompt(basePrompt, ragContext) {
  ...
  const contextContent = ragContext.matches.map((match2, index) => `${index + 1}. **${match2.title || "\u77E5\u8BC6\u70B9"}**:
${match2.content || match2.metadata?.content || ""}`).join("\n\n");
...
// ../.wrangler/tmp/pages-CSFJ7X/functionsRoutes-0.6086405598839693.mjs
var routes = [
  {
    routePath: "/api/chat",
    mountPath: "/api",
...
// ../../.nvm/versions/node/v22.17.1/lib/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../.nvm/versions/node/v22.17.1/lib/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-f1pc2f/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-f1pc2f/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.43833966369077526.mjs.map
