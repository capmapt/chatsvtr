        ...
        <div class="modal-body">
          ...
          <div class="social-login-section">
            <div class="social-login-buttons">
              <button class="btn-oauth btn-google" onclick="this.handleOAuthLogin ? this.handleOAuthLogin('google') : window.location.href='/api/auth/google'">
              ...
              <button class="btn-oauth btn-github" onclick="this.handleOAuthLogin ? this.handleOAuthLogin('github') : window.location.href='/api/auth/github'">
                <svg width="18" height="18" viewBox="0 0 24 24" style="margin-right: 8px;">
              ...
              <button class="btn-oauth btn-linkedin" onclick="this.handleOAuthLogin ? this.handleOAuthLogin('linkedin') : window.location.href='/api/auth/linkedin'">
                <svg width="18" height="18" viewBox="0 0 24 24" style="margin-right: 8px;">
